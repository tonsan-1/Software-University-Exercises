    ...
    public class Deserializer
    {
        public static string ImportDepartmentsCells(SoftJailDbContext context, string jsonString)
        {
            ...
            foreach (var depCell in departmentCells)
            {
                ...
                if (!IsValid(depCell) || !depCell.Cells.All(IsValid) || !departmentCells.Any())
                {
                ...
                {
                    Name = depCell.Name,
                    Cells = depCell.Cells.Select(x => new Cell
                    {
        ...
        public static string ImportPrisonersMails(SoftJailDbContext context, string jsonString)
        {
            ...
            var prisonerMails = JsonConvert.DeserializeObject<IEnumerable<PrisonersMailsImportModel>>(jsonString);
            ...
            foreach (var currentPrisoner in prisonerMails)
            {
                ...
                var isValidIncarcerationDate = DateTime.TryParseExact(currentPrisoner.IncarcerationDate, "dd/MM/yyyy",
        ...
        public static string ImportOfficersPrisoners(SoftJailDbContext context, string xmlString)
        {
            ...
            var oficcerPrisoners = XmlConverter.Deserializer<OfficerPrisonerInputModel>(xmlString, "Officers");

            foreach (var officerPrisoner in oficcerPrisoners)
            {
